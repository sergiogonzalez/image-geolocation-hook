			...
			<div class="body-row asset-details">
				...
				<div class="lfr-asset-panels">
					<liferay-ui:panel-container extended="<%= false %>" id="documentLibraryAssetPanelContainer" persistState="<%= true %>">
						...
						//---Custom code for displaying ubication with google maps---

						double latitude = GetterUtil.getDouble(fileVersion.getExpandoBridge().getAttribute("latitude"));
						double longitude = GetterUtil.getDouble(fileVersion.getExpandoBridge().getAttribute("longitude"));
						...
						if ((latitude != 0) && (longitude != 0)) {
							...
							sb.append(longitude);
							sb.append("&zoom=14&size=250x150&sensor=false&markers=color:blue%7C");
							sb.append(latitude);
							sb.append(StringPool.COMMA);
							sb.append(longitude);
						%>

							<img src="<%= sb.toString() %>" style="margin-left: 10px">
